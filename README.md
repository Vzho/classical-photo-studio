...
顶部“页面装修”提供受控装修能力。先选择“经典作品站”或“暗色品牌画廊”整站结构，再选择东方高定、时尚画册、清透客片、电影叙事、影像艺廊、暗色品牌画廊等商业皮肤。整站结构会真正改变首页、作品目录、作品详情和简介页骨架；切换不会删除照片、文字、分类或服务资料。暗色品牌画廊另有独立作品目录，可配置标题、副标题、搜索、顶部/左侧分类、两列/三列图片、标签、首页按钮、详情按钮和简介引语。

经典作品站继续支持杂志封面、高定目录、影像画廊、门店转化 4 种首页结构；作品区支持错落图文、瀑布流、整齐卡片、横向滑动、大小图混排，可设置 1–4 列、封面比例、照片留白，并独立控制标题、分类和描述。底部可在首页/作品、独立作品目录、简介、套餐、咨询、门店中选择并排序 2–5 个入口；门店入口直接读取后台已有地址、营业时间、电话和地图坐标。保存前会使用当前 COS 客片即时预览，只有点击“保存并更新小程序”后才同步线上配置。系统不开放任意 CSS 或 SVG，避免误操作破坏页面。
