...
后台可管理主题、系列、照片、系列介绍、适合人群、拍摄场景、风格标签、系列关联套餐/摄影师、首页轮播文案、主题预设、预约咨询风格、摄影师资料、头像、门店信息，以及 v1.1 内容模块。套餐、档期、客户评价、咨询按钮、服务流程和 FAQ 支持结构化表单编辑；咨询文本模板保留在内容模块中维护。
...
套餐、档期、客户评价、咨询按钮、服务流程和 FAQ 通过后台“内容模块”里的结构化表单维护，保存时自动写入配置并同步 COS；JSON 文本框只作为高级预览和批量排查入口。
